                ...
                <SwiperSlide>
                  <div className="min-w-[300px] max-w-[345px] shadow-4xl rounded-3xl relative">
                    ...
                    <div className="h-16 bg-zinc-100 rounded-b-xl flex justify-end shadow-[10px-10px-10px-10px]">
                      <Link
                        className="hover:text-blue-300 hover:bg-slate-300 transition transition duration-500 ease-in-out bg-zinc-500 self-center text-zinc-50 rounded-md px-6 py-1 font-bold mr-6 mb-2"
                        href={`/blog/${e.id}`}
                      >
                        Read more
                      </Link>
